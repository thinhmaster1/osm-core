...
namespace OSM.Application.Implementation
{
    ...
    public class RoleService : IRoleService
    {
        ...
        public RoleService(RoleManager<AppRole> roleManager, IUnitOfWork unitOfWork,
          IRepository<Function, string> functionRepository, IRepository<AnnouncementUser, int> announUserRepository, IRepository<Announcement, string> announRepository, IRepository<Permission, int> permissionRepository)
        {
