...
namespace OSM.Utilities.Helpers
{
    public static class TextHelper
    {
        ...
        public static string ToString(decimal number)
        {
            ...
            string[] layer = new string[] { "", "thousand", "million", "billion" };
            string[] tylayer = new string[] { "", "", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety" };
            ...
            else
            {
                ...
                while (i > 0)
                {
                    ...
                    {
                        if (dozen == 1) str = "ten " + str;
                        if (dozen > 1) str = tylayer[dozen] + str;
                    }
                    if (hundred <= 0) break;
                    else
                    {
                        if ((hundred > 0) || (dozen > 0) || (unit > 0)) str = numberWords[hundred] + " hundred " + str;
                    }
                    str = " " + str;
                }
            }
            if (booAm) str = "Minus " + str;
            return str + " dong";
        }
    }
}