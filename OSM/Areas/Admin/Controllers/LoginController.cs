...
using OSM.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Authen(LoginViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.IsLockedOut)
                {
                    ...
                    return new OkObjectResult(new GenericResult(false, "Tài khoản bị khóa."));
                }
                else
                {
                    return new OkObjectResult(new GenericResult(false, "Tài khoản hoặc mật khẩu bị sai."));
