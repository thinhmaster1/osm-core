...
namespace OSM.Areas.Admin.Controllers
{
    public class ProductController : BaseController
    {
        ...
        [HttpPost]
        public IActionResult AddColor(ColorViewModel color)
        {
        ...
        [HttpPost]
        public IActionResult AddSize(SizeViewModel size)
        {
        ...
        [HttpGet]
        public IActionResult GetColor(string name)
        {
            var color = _productService.GetColor(name);
            return new OkObjectResult(color);
        }
        [HttpGet]
        public IActionResult GetSize(string name)
        {
            var size = _productService.GetSize(name);
            return new OkObjectResult(size);
        }
        [HttpGet]
        public IActionResult GetSizeById(int id)
        {
            var size = _productService.GetSizeById(id);
            return new OkObjectResult(size);
        }
        [HttpGet]
        public IActionResult GetColorById(int id)
        {
            var color = _productService.GetColorById(id);
            return new OkObjectResult(color);
        }
        [HttpGet]
        public IActionResult GetQuantities(int productId)
        {
            ...
            {
                quantity.Color = _productService.GetColorById(quantity.ColorId);
                quantity.Size = _productService.GetSizeById(quantity.SizeId);
            }
            return new OkObjectResult(quantities);
        }
