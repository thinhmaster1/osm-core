var RoleController = function () {
    ...
    function registerEvents() {
        ...
        $("#btn-role-create").on('click', function () {
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    osm.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    osm.stopLoading();
                },
                error: function () {
                    osm.notify('Has an error in save permission progress', 'error');
                    osm.stopLoading();
                }
            });
        });
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        osm.notify('Update role successful', 'success');
